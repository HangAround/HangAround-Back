...
### 3. STT
![img](https://www.w3.org/2005/Incubator/htmlspeech/XGR-htmlspeech-20111206/HighLevelSolutionDiagram_V2.jpg)
...
| 이수민  |🔗[링크](https://github.com/leesyum)|백엔드      |이번 프로젝트는 Node.js + TypeScript + Express라는 새로운 프레임워크에 도전하면서 어렵게 느껴지는 부분들이 많았지만, 덕분에 더욱 성장할 수 있었던 것 같습니다. 백엔드 개발 이외에도 와이어프레임 제작과 WebRTC, STT API, AWS 연동 등 다양한 경험을 해볼 수 있었기에 의미가 큰 프로젝트였습니다. 아이디어를 디벨롭하고, 구현을 진행하는 과정에서 어려운 점들도 많았지만 팀원들과 함께 하나하나 해결해 나갔기에 더욱 값진 경험이었습니다. |
